...
void subtractPolynomial(Poly p1[],Poly p2[],Poly p3[]){
	int i=0,j=0,k=0;
...
int main(){
	...
	cout << "The value of polynommial at x = " << x << " is: " << result << endl;
